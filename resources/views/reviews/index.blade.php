    ...
    <div class="py-12" dir="rtl">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                ...
                <a href="{{ route('reviews.mealplans.index') }}" class="group bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:border-green-500 hover:shadow-xl transition-all duration-300 text-center">
                ...
                {{-- زر تقييمات الكورسات --}}
                <a href="{{ route('reviews.courses.index') }}" class="group bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:border-orange-500 hover:shadow-xl transition-all duration-300 text-center">
                ...
                {{-- زر تقييمات الجلسات --}}
                <a href="{{ route('reviews.gymsessions.index') }}" class="group bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:border-purple-500 hover:shadow-xl transition-all duration-300 text-center">
