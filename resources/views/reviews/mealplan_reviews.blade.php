            ...
            <div class="flex flex-col md:flex-row justify-between items-center gap-4 border-b border-gray-200 pb-6">
                <div>
                    <h2 class="text-3xl font-black text-gray-800 tracking-tight">
                        تقييمات الخطط الغذائية 🥗
                    </h2>
                    <p class="text-gray-500 mt-1">
                        آراء المتدربين حول الأنظمة الغذائية وجودة الوجبات.
                    </p>
                </div>
            ...
            <div class="bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden shadow-2xl">
                ...
                @if ($mealplan->isEmpty())
                    <div class="p-20 text-center flex flex-col items-center justify-center">
                        ...
                        <h3 class="text-xl font-bold text-white mb-2">لا توجد تقييمات للوجبات</h3>
                        <p class="text-gray-500">لم يتم تقييم أي خطة غذائية حتى الآن.</p>
                    </div>
                @else
                        ...
                        <table class="w-full text-right">
                            <thead class="bg-black/40 text-gray-400 uppercase text-xs font-bold tracking-wider">
                                <tr>
                                    ...
                                    <th class="px-6 py-4">الخطة الغذائية</th>
                                    ...
                                    <tr class="hover:bg-white/5 transition-colors duration-200 group">
                                        ...
                                        <td class="px-6 py-5">
                                            <div class="flex items-center gap-3">
                                                <div
                                                    class="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-600 to-emerald-600 flex items-center justify-center text-white font-bold text-sm shadow-lg border border-indigo-500/30">
                                        ...
                                        <td class="px-6 py-5 text-center">
                                            <div class="flex flex-col items-center justify-center gap-1">
                                                ...
                                                <div class="flex gap-0.5">
                                                    @for ($i = 1; $i <= 5; $i++)
                                                        <svg class="w-3 h-3 {{ $i <= $tr->rating ? 'text-amber-400' : 'text-gray-700' }} fill-current transition-colors duration-200"
                                                            viewBox="0 0 20 20">
                                                            <path
