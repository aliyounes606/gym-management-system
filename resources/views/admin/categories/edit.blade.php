    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-3xl font-bold text-gray-100 mb-2">تعديل قسم التدريب</h2>
                    <p class="text-gray-400">تحديث اسم تصنيف التمارين الحالي.</p>
                </div>
            ...
            <div class="bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div class="p-6 border-b border-gray-800 bg-gray-800/30 flex items-center gap-3">
                    ...
                    <h3 class="text-lg font-bold text-white">تحديث البيانات: <span
                            class="text-indigo-400">{{ $category->name }}</span></h3>
                </div>
                ...
                <div class="p-8">
                    <form action="{{ route('categories.update', $category->id) }}" method="POST">
                        ...
                        <div class="space-y-6">
                            ...
                            {{-- Category Name --}}
                            <div class="space-y-2">
                                <label for="name" class="text-sm font-bold text-gray-300">اسم القسم (Category
                                    Name)</label>
                                <div class="relative">
